...
const statusIconMap: Record<TaskStatus, React.ReactNode> = {
    ...
    [TaskStatus.IN_REVIREW]: <CircleDotIcon className="size-[18px] text-blue-400" />,
    ...
    return (
        <div className="px-2 py-1.5 flex items-center justify-between">
            <div className="flex items-center gap-x-2">
                ...
                <div className="size-5 flex items-center justify-center bg-neutral-200 rounded-md text-neutral-700 font-medium">
                    {taskCount}
                </div>
            </div>
